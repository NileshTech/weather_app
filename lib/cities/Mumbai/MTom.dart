...
class Tommarrow extends StatefulWidget {
  Tommarrow({Key key}) : super(key: key);

  @override
  _TommarrowState createState() => _TommarrowState();
}

class _TommarrowState extends State<Tommarrow> {
  @override
...
Future<Weather> getTommarrow() async {
  final result = await http.Client().get(
      "http://api.openweathermap.org/data/2.5/onecall/timemachine?lat=$lat&lon=$lon&dt=1596373480&units=metric&appid=$API_KEY");
