...
class Yesterday extends StatefulWidget {
  Yesterday({Key key}) : super(key: key);
...
Future<Weather> getYesterday() async {
  final result = await http.Client().get(
      "http://api.openweathermap.org/data/2.5/onecall/timemachine?lat=$lat&lon=$lon&dt=1596200680&units=metric&appid=$API_KEY");
